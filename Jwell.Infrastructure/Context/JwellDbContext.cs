...
namespace Jwell.Repository.Context
{
    public class JwellDbContext: DbContext
    {
        ...
        public IDbSet<PropellingMovementManager> PropellingMovementManager { get; set; }

        public IDbSet<PropellingMovementLog> PropellingMovementLog { get; set; }

        public IDbSet<PropellingMovementInterface> PropellingMovementInterface { get; set; }
